...
export default function ProjectShowcase() {
  return (
    <div className="mt-44 relative w-full max-w-6xl mx-auto px-6">
      ...
      <div className="relative rounded-[48px] overflow-hidden border border-white/10 shadow-2xl bg-[#0a0a0a]">
        ...
        <div className="h-14 bg-[#151515] border-b border-white/5 flex items-center px-6 gap-2">
            ...
            <div className="ml-6 w-80 h-7 bg-black/50 rounded-xl border border-white/5 flex items-center px-4">
              <span className="text-[11px] text-white/30 truncate">studio.genforge.studio/my-campaign</span>
            </div>
        </div>
        ...
        <div className="aspect-[16/10] flex relative">
            {/* Sidebar (Explorer) */}
            <div className="w-72 bg-[#0a0a0a] border-r border-white/5 p-8 space-y-8 hidden lg:block">
              ...
              <div className="space-y-4">
                  ...
                  <div className="pl-6 space-y-4 text-sm text-white/40 font-medium">
                    <div className="flex items-center gap-3"><span className="text-white/20">›</span> .idx</div>
                    <div className="flex items-center gap-3"><span className="text-white/20">›</span> dist</div>
                    <div className="flex items-center gap-3"><span className="text-white/20">›</span> node_modules</div>
                    <div className="flex items-center gap-3 text-white/80"><span className="text-white/20">⌄</span> scripts</div>
                  </div>
              </div>
            </div>

            {/* Main Editor Content */}
            <div className="flex-1 p-10 bg-[#0d0d0d] font-mono text-[14px] leading-relaxed text-white/40 overflow-hidden">
              <div className="flex items-center gap-4 mb-10 text-xs">
                  ...
                  <div className="px-4 py-2 text-white/20 font-medium">package.json</div>
              </div>
            ...
            <div className="absolute left-10 bottom-10 w-[340px] glass-card rounded-3xl p-8 border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] bg-[#0a0a0a]/90 backdrop-blur-2xl animate-float">
              ...
              <div className="space-y-6">
                  ...
                  <p className="text-white/40 text-sm font-medium leading-relaxed">Build an app that lets me turn images into receipts.</p>
                  <div className="pt-4 border-t border-white/5">
                    <div className="flex items-center justify-between text-[11px] font-bold text-white/40 uppercase mb-4">
            ...
            <div className="absolute right-[-60px] top-1/2 -translate-y-1/2 w-[300px] aspect-[9/18.5] bg-black rounded-[56px] border-[8px] border-[#1a1a1a] shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden hidden xl:block animate-float-delayed">
              <div className="absolute top-0 inset-x-0 h-12 bg-[#1a1a1a] flex items-center px-6 gap-4">
                  <div className="px-3 py-1 bg-white/5 rounded-full text-[10px] font-bold text-white/40 uppercase">Android</div>
                  <div className="text-[10px] font-bold text-white/20 uppercase">Web</div>
              </div>
